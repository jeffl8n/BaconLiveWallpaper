...
import com.builtclean.android.livewallpapers.bacon.donate.BaconLiveWallpaperSettings;
...
public class SeekBarPreference extends Preference implements
	...
	protected View onCreateView(ViewGroup parent) {
		...
		this.originalValue = getSharedPreferences().getInt(getKey(),
				BaconLiveWallpaperSettings.SIZZLE_DURATION_DEFAULT);
